...
from testing.db_tests import test_init_db, test_get_inventory_exists, test_dict_factory_link, test_check_connection_threaded, test_insert_raffle_ticket, test_stock, test_add_to_wishlist, test_remove_from_wishlist, test_display_wishlist, test_insert_wishlist_item
from testing.core_tests import test_init_sessions, test_add_new_session, test_get_session, test_get_session_username, test_get_session_db
import os
...
DB_FUNCS = [test_init_db, test_get_inventory_exists,
            ...
            test_insert_raffle_ticket,
            test_stock,
            test_insert_wishlist_item]

CORE_FUNCS = [test_init_sessions,
              test_add_new_session,
              test_get_session,
              test_get_session_username,
              test_get_session_db]
